...
@WebServlet(name = "ServletGeraImagem", urlPatterns = {"/ServletGeraImagem"})
public class ServletGeraImagem extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       try (PrintWriter out = response.getWriter()) {
           ...
           RandomAccessFile raf;
            ...
            dados = raf.readLine();
            raf.close();
            String parte = dados.split("#")[1];
            //response.setContentType(parte);
            out.println(parte);
        }
    }
